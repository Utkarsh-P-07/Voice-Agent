    ...
    <AuthLayout mode="signup">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          {/* Visual checkbox box */}
          <div
            className="w-5 h-5 rounded-lg flex-shrink-0 mt-0.5 flex items-center justify-center transition-all duration-200"
            style={agreed
          ...
          {/* Label text — stop propagation on links so clicking them doesn't toggle */}
